...
import { FolderIcon, HomeIcon, PinIcon, GiftIcon } from '../../components/icons';
...
export const MainBottomNavigation: React.FC<BottomTabBarProps> = ({ navigation, state, descriptors }) => {
  ...
  return (
    <Animated.View style={[styles.container, transforms, { paddingBottom: tabBarVisible ? safeAreaInsets.bottom : 0 }]}>
      <Divider />
      <BrandBottomNavigation appearance="noIndicator" selectedIndex={state.index} onSelect={onSelect}>
